...
RegisterServerEvent('esx_mdc:fee')
AddEventHandler('esx_mdc:fee', function()
local _source = source
local xPlayer = ESX.GetPlayerFromId(_source)
xPlayer.addMoney(fee * 0.2)
end)
