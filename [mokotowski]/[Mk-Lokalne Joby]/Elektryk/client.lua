...
Citizen.CreateThread(function()
    while true do
        ...
        if distance <= 5 then
            sleep = 0
            DrawMarker(27, -825.55084228516, -731.86492919922, 27.074931640625,
                       0, 0, 0, 0, 0, 0, 1.5, 1.5, 1.0, 255, 27, 6, 500, 0, 0,
                       0, 0)
                ...
                if not trabalhando then
                    ...
                    if IsControlJustPressed(0, 38) then
                        sleep = 5
                            ...
                            Citizen.Wait(10000)
                            Notificacion("Podjedź pod latarnię, wejdź po drabinie, i napraw latarnię.")
    ...
    while true do
        ...
        if segundos > 0 then
            ...
            if segundos == 0 then
                ...
                TriggerServerEvent('rtwbtwrwwtwwh6wh56wh5hw656wh564h654wh', Config.Pay)
            end
        else
            Citizen.Wait(1000)
        end
