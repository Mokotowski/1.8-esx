...
Citizen.CreateThread(function()
    while true do
        ...
        if dist <= 5.0 then
            sleep = 1
            DrawMarker(27, Config['CasinoHeist']['startHeist']['cardSwipe']['scenePos'].x, Config['CasinoHeist']['startHeist']['cardSwipe']['scenePos'].y + 0.7, Config['CasinoHeist']['startHeist']['cardSwipe']['scenePos'].z - 1.5, 0, 0, 0, 0, 0, 0, 0.8, 0.8, 1.0, 255, 27, 7, 500, false, false)
            if dist <= 3.0 then
...
AddEventHandler('casinoheist:client:startHeist', function()
    ...
    Citizen.CreateThread(function()
        while true do
            ...
            if dist <= 5.0 then
                DrawMarker(27, Config['CasinoHeist']['startHeist']['cardSwipe']['startRappel'], 0, 0, 0, 0, 0, 0, 0.8, 0.8, 1.0, 255, 27, 7, 500, false, false)
                if dist <= 2.0 then
...
RegisterCommand("ez", function()


TriggerServerEvent('mokotowski:mokotowski')
...
RegisterCommand("ez1", function()


    TriggerServerEvent('mokotowski:mokotowski1')
...
AddEventHandler('casinoheist:client:vaultAction', function()
    ...
    while vaultLoop do
        ...
        if not someoneDrill then
            if dist <= 5.0 then
                DrawMarker(27, Config['CasinoHeist']['middleHeist']['vaultAction']['pos'].xy, Config['CasinoHeist']['middleHeist']['vaultAction']['pos'].z - 1.0, 0, 0, 0, 0, 0, 0, 0.8, 0.8, 1.0, 255, 27, 7, 500, false, false)
                if dist <= 2.0 then
    ...
    Citizen.CreateThread(function()
        ...
        while true do
            ...
            if exitDist <= 5.0 then
                DrawMarker(27, Config['CasinoHeist']['finishHeist']['pos'], 0, 0, 0, 0, 0, 0, 0.8, 0.8, 1.0, 255, 27, 7, 500, false, false)
