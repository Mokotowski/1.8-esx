...
Strings = { 
    ['start_heist'] = 'naciśnij ~INPUT_CONTEXT~ aby rozpocząć napad na kasyno', 
    ['wait_nextheist'] = 'czas do następnego napadu', 
    ['minute'] = 'minut.', 
    ['need_item'] = 'Potrzebujesz: ', 
    ['police_alert'] = 'Rozpoczęto napad na kasyno!', 
    ['go_rappel'] = 'idź do liny', 
    ['rappels_busy'] = 'wszystkie liny są zajęte spróbuj ponownie za chwilę', 
    ['rappel_start'] = 'Press ~INPUT_CONTEXT~ aby zchodzić', 
    ['rappel_action'] = '~INPUT_MOVE_DOWN_ONLY~ w dół / ~INPUT_PICKUP~ aby zjechać', 
    ['go_base'] = 'idź do podziemi', 
    ['emp_activated'] = 'EMP jest aktywne, zachowaj czujność', 
    ['emp_deactivated'] = 'EMP zostało wyłączone, idź do środkowych drzwi', 
    ['swipe_card_base'] = 'naciśnij ~INPUT_CONTEXT~ aby użyć karty', 
    ['door_opened'] = 'drzwi zostały otwarte, idź do skarbca', 
    ['laser_drill'] = 'naciśnij ~INPUT_CONTEXT~ aby użyć wiertłą laserowego', 
    ['vault_open'] = 'Sprawdź GPS,  wyjdź z kasyna. Będziesz musiał ponownie użyć drzwi dla personelu', 
    ['grab'] = 'naciśnij ~INPUT_CONTEXT~ aby wziąć wózek', 
    ['lockbox_drill'] = 'naciśnij ~INPUT_CONTEXT~ aby dostać się do skrytki', 
    ['hack_keypad'] = 'naciśnij~INPUT_CONTEXT~ aby hakować', 
    ['exit_casino'] = 'naciśnij ~INPUT_CONTEXT~ aby opuścić kasyno', 
    ['deliver_to_buyer'] = 'zawieź łup do kupca', 
    ['base_blip'] = 'podziemia', 
    ['middle_doors_blip'] = 'środkowe drzwi', 
    ['vault_blip'] = 'sejf', 
    ['exit_blip'] = 'opuść kasyno', 
    ['buyer_blip'] = 'Kupiec'
}
