...
Config['HumaneLabs'] = {
    ...
    ['rewards'] = {
        ...
        ['items'] = { -- you can disable this, just make ['items'] = nil
            { name = 'gold', count = function() return math.random(30, 50) end},
            { name = 'diamond', count = function() return math.random(30, 50) end}
        }
    },
    ['minigameDifficulty'] = {
        ['selected'] = 'easy',
...
Strings = {
    ['start_heist'] = 'Naciśnij ~INPUT_CONTEXT~ aby rozpocząć napad na HUMAN LABS',
    ['finish_heist'] = 'Naciśnij ~INPUT_CONTEXT~ aby zakończyć napad',
    ['go_diving'] = 'Udaj się na gps. Przygotuj strój nurka i dużo masek tlenowych. Uważaj na ochrone',
    ['wait_nextrob'] = 'Musisz poczkeać przed kolejnym napadem',
    ['minute'] = 'minut.',
    ['elevator'] = 'Naciśnij ~INPUT_CONTEXT~ aby pojechać na górę.',
    ['go_tunnel'] = 'Płyń do końca tunelu.',
    ['put_chemical'] = 'Idź do wyjścia i włóż substancję chemiczną do kontenera. Uważaj!',
    ['end'] = 'Helikopter przyleci po kontener. Wróć do miejsca, w którym otrzymałeś zadanie i odbierz nagrodę.',
    ['finish_blip'] = 'Zakończ napad',
    ['take_blip'] = 'Weź chemikalia',
    ['put_blip'] = 'Odłóż chemikalia',
    ['police_alert'] = 'Napad na Humane Labs. Sprawdź gps',
    ['need_police'] = 'Nie ma wystarczającej ilość policji.',
}
