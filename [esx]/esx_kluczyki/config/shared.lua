...
Config = {
	...
	key = Keys['U'],
	specialkey = Keys['LEFTSHIFT'],	-- e.g : Keys["H"] will be change the U key to the H key for lock/unlock a vehicle
	lockTimer = 1.00,					-- Timer between two changes (open/close - in seconds)
	randomMsg =	{
	"Wziąłeś klucze",
	}
}