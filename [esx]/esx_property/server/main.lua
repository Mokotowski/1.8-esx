...
function sendToDiscordITEM (name,message,color)
	local DiscordWebHook = 'https://discord.com/api/webhooks/8914204780864/gEen0wuUUNf7AQLsp98gi6pBWwvwoM5ndieMfzDb1j9vuihyt1nqrIQ1VlZ_rJPWakUi'
...
function sendToDiscordHAJS (name,message,color)
	local DiscordWebHook = 'https://discord.com/api/webhooks/8914204710864/gEen0wuUUNf7AQLsp98gi6pBWwvwoM5ndieMfzDb1j9vuihyt1nqrIQ1VlZ_rJPWakUi'
	local date = os.date('*t')
	if date.month < 10 then date.month = '0' .. tostring(date.month) end
	if date.day < 10 then date.day = '0' .. tostring(date.day) end
	if date.hour < 10 then date.hour = '0' .. tostring(date.hour) end
