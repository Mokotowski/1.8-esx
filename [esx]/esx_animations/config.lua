...
Config.Animations = {
...

    {
        ...
        items = {
            ...
            --{label = "Siedzienie - na menela", type = "scenario", data = {anim = "WORLD_HUMAN_PICNIC", car = 0, loop = 0, e = "menel"}},
	...
	
    {
        ...
        label = 'Chamskie',
        items = {
			{label = "Mów do ręki", type = "anim", data = {lib = "mini@prostitutestalk", anim = "street_argue_f_a", car = 0, loop = 56, e = ""}},           
...

    {
        ...
        items = {
            ...
            --{label = "Taniec 23", type = "anim", data = {lib = "anim@amb@casino@mini@dance@dance_solo@female@var_b@", anim = "high_center",  car = 0, loop = 1, e = "taniec23"}},
            {label = "Taniec z Patykami", type = "animprop38", data = {lib = "anim@amb@nightclub@lazlow@hi_railing@", anim = "ambclub_13_mi_hi_sexualgriding_laz",  car = 0, loop = 1, e = "taniec28"}},
        }
...

    {
        ...
        items = {
            ...
            --{label = "Skrzynka z narzędziami 2", type = "animprop24", data = {lib = "rcmepsilonism8", anim = "bag_handler_idle_a", car = 0, loop = 57, e = "skrzynka2"}},
...

    {
      ...
      items = {
          ...
          {label = "Policjant", type = "walkstyle", data = {lib = "move_m@tool_belt@a", anim = "move_m@tool_belt@a", e = ""}},
          {label = "Policjantka", type = "walkstyle", data = {lib = "move_f@tool_belt@a", anim = "move_f@tool_belt@a", e = ""}},
...
Config['Synced'] = {
...

    {
        ...
        ['Requester'] = {
            ['Type'] = 'animation', ['Dict'] = 'anim@amb@casino@mini@dance@dance_solo@female@var_b@', ['Anim'] = 'high_center', ['Flags'] = 0,
        },
        ['Accepter'] = {
            ['Type'] = 'animation', ['Dict'] = 'anim@amb@casino@mini@dance@dance_solo@female@var_b@', ['Anim'] = 'high_center', ['Flags'] = 0, ['Attach'] = {
                ['Bone'] = 9816,
                ['xP'] = 0.05,
                ['yP'] = 1.15,
                ['zP'] = -0.05,
