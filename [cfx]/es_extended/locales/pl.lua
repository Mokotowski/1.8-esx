Locales['pl'] = {
  ...
  ['cash'] = 'gotówka',
  ['gave_ammo'] = 'przekazałeś %sx naboje dla %s.',
  ['received_ammo'] = 'otrzymałeś %sx naboje od %s.',
  ['gave_money'] = 'przekazałeś %s$ dla %s',
  ['received_money'] = 'otrzymałeś %s$ od %s',
  ['threw_money'] = 'wyrzuciłeś $%s',
  ['black_money'] = 'brudne pieniądze',
  ['cannot_pickup_room'] = 'nie masz wystarczająco dużo miejsca w ekwipunku, aby podnieść %s!',
